        ...
        return (
            <Box
                ...
                <Flex alignItems='center'>
                    ...
                    <Text>{text}</Text>
                    <Spacer />
                    <Text color='#4B4B4B' fontSize={15} fontWeight={400}>{value}</Text>
    ...
    return (
        <Box shadow='lg' width={400} bg='white' borderTopRadius={40} borderBottomRadius={20} pt={1} display='block'>
            <Box
                ...
                pt={7.5}>
                <Flex>
                    <IconButton aria-label="back" variant='link' colorScheme='blue' icon={<Icon as={ChevronLeft} onClick={() => setView(ViewType.SearchResults)} />} />
                    <Spacer />
