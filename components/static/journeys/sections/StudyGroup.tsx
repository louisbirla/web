  ...
  <Section>
    ...
    <Steps
      steps={[
        ...
        `Sal clicks on the message input to send a message (behind the scenes, this makes a Text block) and asks for some help.
        They offer to pay whoever can tutor them with some credits.`,
        ...
        `Throughout the discussion, Dillan sends some document blocks he’s made before in the chat,
        by pressing the “+” button as before but choosing an existing block, and searching for it.`,
        `Sal and Dillan conclude talking, and so Sal clicks on Dillan’s profile picture, which brings Dillan’s page.
        They click on a button to send credits, and type the amount. Sal then clicks a button to confirm the transaction.`,
